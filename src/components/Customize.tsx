...
const Customize: React.FC<CustomizeProps> = memo(
  ({ currentOpenSection, toggleOpenThisSection, loadExample, clearResume }) => {
      ...
      <section className="shadow-md shadow-dark max-w-md mx-auto my-4 text-darker relative bg-white">
        ...
        <div className={'p-4' + (isThisSectionOpened ? ' block' : ' hidden')}>
          <div className="flex items-center justify-evenly">
            <button
              type="button"
              className="flex items-center justify-center shadow-custom gap-2"
              onClick={clearResume}
            >
          ...
          <div className="flex items-center justify-center mt-2">
            <button
              ...
              className="flex items-center justify-center shadow-custom gap-2"
            >
              <Icon.Download color={'#a00'} width={'30px'} height={'30px'} />{' '}
              Download Resume
            </button>
          </div>
        </div>
