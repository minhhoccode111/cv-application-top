...
const Education: React.FC<EducationProps> = memo(
  ({ educationItems, formOnSubmitCb, currentOpenSection, deleteEducationItem, toggleOpenThisSection, educationDispatch, educationStates, toggleHiddenEducationItem }) => {
      ...
      JSXToDisplayInThisSection = (
        ...
        >
          ...
          <div className="flex justify-evenly px-2 py-4">
            <button className="shadow-custom" onClick={() => setIsDisplayForm(!isDisplayForm)} type="button">
              Cancel
            </button>
      ...
      JSXToDisplayInThisSection = (
        <div className="">
          ...
          <div className="flex justify-center p-2">
            <button type="button" className="hover:scale-125 transition-transform" onClick={() => setIsDisplayForm(!isDisplayForm)}>
